...
abstract public class Base {
    ...
    private final class GLEventDelegate implements GLEventListener {
        ...
        public void init(GLAutoDrawable drawable) {
            ...
            X = loadTexture("textures/x.jpg");
            O = loadTexture("textures/o.jpg");
            ...
            switch (e.getKeyChar()) {
                ...
                case 'a':
                    gs.cnt = gs.cnt.subtract(
                            new Vector(Math.cos(phiQ), Math.sin(phiQ), 0).scale(CENTER_POINT_CHANGE));
                    break;
                // Left.
                case 'd':
                    gs.cnt = gs.cnt.add(
                ...
                case 'w':
                    gs.cnt = gs.cnt.subtract(
                            new Vector(Math.cos(gs.phi), Math.sin(gs.phi), 0).scale(CENTER_POINT_CHANGE));
                    break;
                // Backwards.
                case 's':
                    gs.cnt = gs.cnt.add(
